    ...
    <div className={styles.rubrics}>
      {
        rubricsArray.map(item =>
          <Rubric onClick={() => push(`/${item.text.toLowerCase().split(" ").join("_")}`)} key={item.id} item={item} />   
        )
      }
    </div>
  )
...
const rubricsArray = [
  ...
  {id: 8, link: '/assets/images/newrub3.jpg', width: "564px", height: "312px", text: "ЖАНЧЫНА - КРЫНIЦА НАТХНЕННЯ", positionX: "center", positionY: "center"},
  {id: 6, link: '/assets/images/newrub1.jpg', width: "372px", height: "312px", text: "30 ФОТОИСТОРИЙ", positionX: "center", positionY: "center"},
  {id: 5, link: '/assets/images/6rub.jpg', width: "372px", height: "336px", text: "БЛОКНОТ", positionX: "center", positionY: "top"},
  {id: 7, link: '/assets/images/7rub.jpeg', width: "564px", height: "336px", text: "ПОБЕДА В ЛИЦАХ", positionX: "center", positionX: "center"},
]
